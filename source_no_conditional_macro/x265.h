...
#define X265_ANALYSIS_ON	0
#define SLICETYPE_P_B_ON	0
#define WPP_ON				0
#define PARAM_OPTIONS_ON	0
#define ATOMIC_CTUSIZE		0
#define Lookahead_Del
#define Rc_Del
#define THREAD_DEL			1
#define THREAD_POOL_DEL		1
#define RECONPLAY_DEL		1
#define YUV_THREAD_DEL		1
#define Y4M_DEL				1
#define REDANDENCY_DEL		1
